---
title: 'Report 1: Price, Sales, and Revenue'
author: "Barbara Chen"
date: "2023-06-08"
editor_options:
  markdown:
    wrap: 72
---
This report will analyze the distribution of prices, sales, and revenue of 600 coffee table-related products on Amazon. The keywords used to gather these products are "_coffee table, nightstand, side table, end table, bedside table, sofa table, living room table, and accent table_". 
...
```{r}
ggplot(price_groups, aes(price_group, fill = price_group)) + geom_bar() + 
  scale_y_continuous(breaks = scales::pretty_breaks(n=10)) +
